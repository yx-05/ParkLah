export const PAYMENT_GATEWAY_PORT = Symbol('IPaymentGatewayPort');
...
export interface IPaymentGatewayPort {
  ...
  processPayout(userId: string, amount: number, bankDetails: Record<string, any>): Promise<{ payoutId: string; status: string }>;
}
