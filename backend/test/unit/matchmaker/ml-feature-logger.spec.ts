...
} from '../../../src/modules/matchmaker/domain/ports/ml-feature-repository.port';

describe('MlFeatureLoggerService', () => {
  let service: MlFeatureLoggerService;
  let mockRepo: jest.Mocked<IMlFeatureRepositoryPort>;
  ...
  beforeEach(() => {
    ...
    service = new MlFeatureLoggerService(mockRepo);
  });

  it('should save feature snapshot cleanly', async () => {
    const record: MlMatchFeatureRecord = {
      matchId: 'match-123',
