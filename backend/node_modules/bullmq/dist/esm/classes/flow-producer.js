...
import { forwardConnectionError, getParentKey, isRedisInstance, randomUUID, trace, } from '../utils';
...
export class FlowProducer extends EventEmitter {
    ...
    createScripts(queue) {
        ...
        // Scripts instance.
        return (_a = queue.scripts) !== null && _a !== void 0 ? _a : createScripts(queue);
    }
    emit(event, ...args) {
    ...
    async addBulk(flows) {
        ...
        return trace(this.telemetry, SpanKind.PRODUCER, '', 'addBulkFlows', '', async (span) => {
            ...
            for (let index = 0; index < jobsTrees.length; ++index) {
                ...
                if (typeof jobId === 'number' && jobId < 0) {
                    throw this.toFlowError(jobId, getParentKey((_b = (_a = flows[index]) === null || _a === void 0 ? void 0 : _a.opts) === null || _b === void 0 ? void 0 : _b.parent));
                }
                if (typeof jobId === 'string') {
